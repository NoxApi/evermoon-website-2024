...
const Footer = () => {
  ...
  useEffect(() => {
    ...
    const e4 = document.getElementById("spray1");
    if (inViewport) {
  ...
  justify-center  "
      ...
      <div
        id="spray1"
        className="flex h-auto w-auto justify-center gap-x-[8px] opacity-0 
            transition-all delay-200 duration-1000 "
      >
        <div
          id="icons"
          className="flex gap-x-[8px] transition-all duration-1000 smm:flex-col  smm:gap-y-[1vw]"
        >
            ...
            <div className="p-1 ">
              <LinkNewTab href="https://twitter.com/EverMoon_nft">
                <svg
                  ...
                  height="16"
                  viewBox="0 0 16 16"
                  className=" icon_hover w-[24px] smm:w-[6.4vw] "
                >
                  <mask
                    id="mask0_7520_1161"
